	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		for (int i = 0; i < 10; i++) {
			...
			case 1:
				...
				break;
			case 2:
				correctAns = ques[i].getOption2();
				break;
			case 3:
				correctAns = ques[i].getOption3();
				break;
			case 4:
				correctAns = ques[i].getOption4();
				break;
			}
			if (ans[i + 1][1] == 1)
				userInt = 1;
			...
			if (userInt == 0) {
				...
				case 1:
					...
					break;
				case 2:
					userAns = ques[i].getOption2();
					break;
				case 3:
					userAns = ques[i].getOption3();
					break;
				case 4:
					userAns = ques[i].getOption4();
					break;
				}
			}
