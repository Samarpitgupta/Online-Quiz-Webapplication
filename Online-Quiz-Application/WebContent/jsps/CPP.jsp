...
<%@page import="com.codster.service.*"%>
...
<body>
	...
	<h2>
		<div align="right">
			Ends in <span id="time">09:59</span> minutes!
		</div>
	</h2>
	<div id="a1">
		<div class="navbar navbar-default  navbar-fixed-top">
			...
			<div class="navbar-collapse collapse">
				<li class="nav"><h2 align="Center">
						<u>CPP MCQ Test</u>
					</h2></li> <a href="logout" align="right">Logout</a>
			</div>
		</div>
		<br>
		<br>
...
%>
				...
				<div class='row'>
					<div class='col-md-12'>
						...
						<input type="radio" name="<%=i+"op1"%>">A.
						<%=q.getOption1() %><br> <input type="radio"
							name="<%=i+"op2"%>">B.
						<%=q.getOption2() %><br> <input type="radio"
							name="<%=i+"op3"%>">C.
						<%=q.getOption3() %><br> <input type="radio"
							name="<%=i+"op4"%>">D.
						<%=q.getOption4() %>
